  ...
  <div class="json-editor">
    ...
    <template v-if="isSimpleValue">
      <input
        ...
        class="w-full px-2 py-1 text-sm border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
        ...
        <div class="space-y-2 pl-4 border-l-2 border-gray-200 dark:border-gray-700">
          ...
          >
            <div class="flex items-center gap-2">
              <input
                :value="key"
                @input="renameObjectKey(key, $event.target.value)"
                class="px-2 py-1 text-sm font-mono bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 rounded focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
      ...
      <div v-if="showAddKeyDialog" class="fixed inset-0 bg-black/50 flex-center z-50" @click="showAddKeyDialog = false">
        <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg min-w-80" @click.stop>
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
