...
/**
 * Command Box 键盘导航处理 Hook
 * 处理 Command Box 内的键盘事件和导航逻辑
 *
 * 注意：全局快捷键功能已迁移到统一快捷键管理系统
 * @see packages/desktop/src/renderer/src/components/shortcuts
 */
...
// 保持向后兼容性的别名
export const useKeyboard = useCommandBoxKeyboard

/**
 * Command Box 搜索输入框键盘处理 Hook
 * 专门处理 Command Box 搜索输入框的键盘事件
 */
export function useCommandBoxSearchKeyboard({
  onArrowDown,
  onArrowUp,
  onEnter,
  onEscape
...
// 保持向后兼容性的别名
export const useSearchKeyboard = useCommandBoxSearchKeyboard
